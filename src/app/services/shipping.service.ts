...
export class ShippingService {
  ...
  getFrete(originZipCode: string, destinationZipCode: string, weight: number, height: number, width: number, length: number, accessKey: string): Observable<ShippingReturn | {msg:string}> {
